...
Anhand der öffentlich zugänglichen S-Boxen kann eine Differenzenverteilungstabelle aufgestellt werden. In dieser wird für jede Eingangsdifferenz die Zahl \todo{wäre da nicht "die Anzahl der Wertepaare.." verständlicher?} Wertepaar gegeben welche eine bestimmte Ausgangsdifferenz erzeugen. 
